...
**Current status:** in development (v0.5.0) — capture adapters for Claude Code and the Antigravity IDE, optional team server with web console (per-model usage and cost estimates, list prices loadable from benchlm.ai).
